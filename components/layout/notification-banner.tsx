        ...
        <div className="flex items-center gap-2 animate-in fade-in slide-in-from-top-4 duration-500">
            <Link href={link}>
                <div className="flex items-center bg-background/40 backdrop-blur-md border border-muted-foreground/30 hover:border-muted-foreground/50 transition-colors rounded-full pl-1.5 pr-4 py-1.5 cursor-pointer group">
                    <span className="bg-[#1f2f32] dark:bg-[#1a2b2e] text-[#4db8a6] px-3 py-1 rounded-full text-xs font-medium tracking-wide mr-3">
                        {tag}
                    </span>
            ...
            <button
                ...
                className="p-2 min-w-[44px] min-h-[44px] flex items-center justify-center hover:bg-secondary rounded-full text-muted-foreground transition-colors"
            >
                <X size={16} />
            </button>
        </div>
